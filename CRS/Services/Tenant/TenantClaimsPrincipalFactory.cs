...
namespace CRS.Services.Tenant {
    ...
    public class TenantClaimsPrincipalFactory : UserClaimsPrincipalFactory<ApplicationUser, IdentityRole<System.Guid>> {
        ...
        protected override async Task<ClaimsIdentity> GenerateClaimsAsync(ApplicationUser user) {
            ...
            // Load scoped role assignments for current tenant or platform (TenantId == 0)
            try {
                ...
                var assignments = await db.UserRoleAssignments
                    .Include(a => a.Role!)
                    .Where(a => a.UserId == user.Id && (a.TenantId == 0 || a.TenantId == currentTenantId))
                    .ToListAsync();
                ...
                foreach (var a in assignments) {
                    ...
                    if (a.TenantId != 0) identity.AddClaim(new Claim("alx_role_tenant", a.TenantId.ToString()));
                }
            } catch {
